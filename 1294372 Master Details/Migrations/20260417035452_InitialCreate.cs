...
namespace _1294372_Master_Details.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceAge = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceEntries_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceEntries_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceEntries_CustomerId",
                table: "ServiceEntries",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceEntries_ServiceId",
                table: "ServiceEntries",
                column: "ServiceId");
        }
